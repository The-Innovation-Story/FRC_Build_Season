...
public class SwerveDriveSubsystem extends SubsystemBase {
    ...
    private static final AHRS m_navx = new AHRS(SPI.Port.kMXP, (byte) 400); // NavX connected over MXP
    ...
    private SwerveDriveOdometry m_odometry = new SwerveDriveOdometry(m_kinematics,
            getGyroHeading(), new Pose2d(5.0, 13.5, new Rotation2d(0.0)));
    ...
    public void resetPose() {
        this.m_odometry.resetPosition(this.m_pose, getGyroHeading());
    }
    ...
    public void periodic() {
        ...
        this.m_pose = m_odometry.update(getGyroHeading(), states[0], states[1],
                states[2], states[3]);
